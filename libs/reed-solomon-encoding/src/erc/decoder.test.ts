    ...
    describe('error-corrector', () => {
        describe('correctErrors', () => {
            test('should decode properly', function () {
                ...
                const sut = createErrorCorrector(10);

                // ACT
                const result = sut.correctErrors(input);
        ...
        describe('calcSyndromes', () => {
            test('valid codeblock, returns no syndromes', function () {
                ...
                // ACT
                const result = sut.calcSyndromes(input);
        ...
        describe('_findErrorLocations', () => {
            test('invalid codeblock, returns some locations', function () {
                ...
                // ACT
                const result = sut.findErrorLocations(syndromes, 21);
        ...
        describe('_correctMsg', () => {
            test('invalid codeblock, corrects message', function () {
                ...
                // ACT
                const result = sut.correctErrorValues(msg, syndromes, errorPositions);
